...
Friend Module Util
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub LongCor(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub Crank(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub Island(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub Corner3(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub Crank3(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub UType3(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub MainReinf(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub SlabBndg(xlApp As Application)
    ...
    ''' </summary>
    ''' <param name="xlApp">Excel Application.</param>
    Friend Sub SlabReinfBndg(xlApp As Application)
